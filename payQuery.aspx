<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payQuery.aspx.cs" Inherits="ReapalFastApiDemo.payquery" %>
<!DOCTYPE html>
...
<body>
    ...
    <div align="center">
			...
			<table class="base input">
                <caption>查询接口<span class="back"><a href="index.aspx">返回目录</a></span></caption>
                <tbody>
                    <tr>
						<th><span class="red">*</span>商户号：</th><td><asp:TextBox id="merchant_id" Text="100000000000147" runat="server" /></td>
					</tr>
                    <tr>
						<th><span class="red">*</span>商户订单号：</th><td><asp:TextBox id="order_no" Text="" runat="server" /></td>
					</tr>
                    <tr>
						<th><span class="red">*</span>版本号：</th><td><asp:TextBox id="version" Text="3.1.6"  runat="server" />3.1.6</td>
					</tr>
                </tbody>
