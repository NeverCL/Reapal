<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cannelCard.aspx.cs" Inherits="ReapalFastApiDemo.cannelCard" %>
<!DOCTYPE html>
...
<body>
    ...
    <div align="center">
			...
			<table class="base input">
                <caption>融宝快捷解绑卡接口<span class="back"><a href="index.aspx">返回目录</a></span></caption>
                <tbody>
					<tr>
    ...
    <script type="text/javascript">
        function checkForm()//验证手机 
        {
            ...
            var bind_id = document.getElementById("bind_id");
            if (bind_id.value == "") {
                alert("绑卡号不能为空！");
                bind_id.focus();
                return false;
