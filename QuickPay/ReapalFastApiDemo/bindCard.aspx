<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bindCard.aspx.cs" Inherits="ReapalFastApiDemo.bindCard" %>
<!DOCTYPE html>
...
<body>
    ...
    <div align="center">
			...
			<table class="base input">
                <caption>融宝快捷绑卡签约接口<span class="back"><a href="index.aspx">返回目录</a></span></caption>
                <tbody>
					<tr>
						<th><span class="red">*</span>商户号：</th><td><asp:TextBox id="merchant_id" Text="" runat="server" /></td>
					</tr>
                    <tr>
						<th><span class="red">*</span>商户会员号：</th><td><asp:TextBox id="member_id" Text="" runat="server" /></td>
					</tr>
                    <tr>
						<th><span class="red">*</span>绑卡号：</th><td><asp:TextBox id="bind_id" Text="" runat="server" /></td>
					</tr>
                    <tr>
						<th><span class="red">*</span>交易金额：</th><td><asp:TextBox id="total_fee" Text="" runat="server" /></td>
					</tr>
