<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="submit.aspx.cs" Inherits="ReapalFastApiDemo.submit" %>
<!DOCTYPE html>
...
<body>
    ...
    <div align="center">
			...
			<table class="base input">
                <caption>融宝快捷确认支付接口<span class="back"><a href="index.aspx">返回目录</a></span></caption>
                <tbody>
					<tr>
                    ...
                    <tr>
						<th><span class="red">*</span>验证码：</th><td><asp:TextBox id="check_code" Text="" runat="server" /></td>
					</tr>
