<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="queryBankCard.aspx.cs" Inherits="ReapalFastApiDemo.queryBankCard" %>
<!DOCTYPE html>
...
<body>
    ...
    <div align="center">
			...
			<table class="base input">
                <caption>融宝快捷卡信息查询接口<span class="back"><a href="index.aspx">返回目录</a></span></caption>
                <tbody>
					<tr>
