<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bindListQuery.aspx.cs" Inherits="ReapalFastApiDemo.bindListQuery" %>
<!DOCTYPE html>
...
<body>
    ...
    <div align="center">
			...
			<table class="base input">
                <caption>融宝快捷查询绑卡列表接口<span class="back"><a href="index.aspx">返回目录</a></span></caption>
                <tbody>
					<tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RadioButtonList id="bank_card_type" runat="server">
                               <asp:ListItem Value="0" selected="true">储蓄卡</asp:ListItem>
