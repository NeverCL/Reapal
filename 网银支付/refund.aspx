...
<body>
    ...
    <div align="center">
			...
			<table class="base input">
                <caption>退款接口<span class="back"><a href="index.aspx">返回目录</a></span></caption>
                <tbody>
					<tr>
                    ...
                    <tr>
						<th><span class="red">*</span>退款金额：</th><td><asp:TextBox id="amount" Text="" runat="server" />（单位：元）</td>
					</tr>
                    <tr>
						<th><span class="red">*</span>退款说明：</th><td><asp:TextBox id="note" Text="" runat="server" /></td>
					</tr>
                    <tr>
						<th><span class="red">*</span>版本号：</th><td><asp:TextBox id="version" Text="3.1.6" runat="server" /></td>
					</tr>
